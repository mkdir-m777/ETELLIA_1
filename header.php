...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/sass/style-common.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/sass/style-salon.css">
